    ...
    @if (session()->has('success'))
     ...
     @endif 
        ...
        <div class="flex__box flex__box--secondary">
            ...
            @else
                <span class="text--lg">{{ $user->name ?: 'Not set' }}</span>
                <button class="button button--edit" wire:click.prevent="startEditing('name')">Edit</button>
            @endif
        </div>
        ...
        <div class="flex__box flex__box--secondary">
            ...
            @else
                <span class="text--lg">{{ $user->email ?: 'Not set' }}</span>
                <button class="button button--edit" wire:click.prevent="startEditing('email')">Edit</button>
            @endif
        </div>
        ...
        <div class="flex__box flex__box--secondary">
            ...
            @else
                <span class="text--lg">{{ $password_hidden ?: 'Not set' }}</span>
                <button class="button button--edit" wire:click.prevent="startEditing('password')">Edit</button>
            @endif
        </div>
